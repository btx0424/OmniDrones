...
class Forest(IsaacEnv):
    ...
    def _design_scene(self):
        ...
        self.forest_size = (length, width, r) = 16, 8, 1.5
        trees = poisson_disk_sampling(length, width, r) + torch.tensor([1., -width/2])
    ...
    def _reset_idx(self, env_ids: torch.Tensor):
        ...
        target_pos[..., 0] = self.forest_size[0] + 2
        target_pos[..., 1].uniform_(-self.forest_size[1]/2, self.forest_size[1]/2)
        target_pos[..., 2] = 1.5
