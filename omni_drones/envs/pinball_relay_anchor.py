...
class PingPongRelayAnchor(IsaacEnv):
    def __init__(self, cfg, headless):
        ...
        self.init_ball_offset_dist = get_dist(
            cfg.task.ball_offset_dist, device=self.device
        )

        self.init_drone_pos_dist = get_extended_pos_dist(
            *cfg.task.drone_xyz_dist.low,
            *cfg.task.drone_xyz_dist.high,
            device=self.device
        )
