...
from omni_drones.robots.drone import Crazyflie, Firefly, Hummingbird, Neo11
...
class Hover(IsaacEnv):
    ...
    def _design_scene(self):
        ...
        self.drone.spawn(translation=(0.0, 0.0, 1.0))
    ...
    def _compute_reward_and_done(self):
        ...
        return TensorDict(
            {"reward": {"drone.reward": reward.unsqueeze(-1)}, "done": done},
            self.batch_size,
        )
