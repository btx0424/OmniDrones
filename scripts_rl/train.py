...
from omni_drones.utils.envs.transforms import LogOnEpisode, RecordOnEpisode
...
def main(cfg):
    ...
    camera = Camera(
        camera_cfg, 
        "/World",
        translation=(2., 2., 2.), target=(0., 0., 1)
    )
    ...
    def evaluate():
        ...
        def record_frame(*args, **kwargs):
            env.sim.render()
            frames.append(camera()["rgb"].clone().cpu())
